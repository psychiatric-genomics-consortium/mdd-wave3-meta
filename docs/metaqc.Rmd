...
```{r meta_sample_size, fig.width=7, fig.height=7}
...
Convert observed scale to liability scale with a range of population prevalences:
...
```{r rg_mat_corr, fig.width=12, fig.height=12}
