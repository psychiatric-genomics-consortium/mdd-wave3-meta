...
```{bash, eval=T, echo=F}
cp /users/k1806347/brc_scratch/Analyses/Lorenza/Clean/TWAS/MDD_TWAS_AllTissues_Manhattan.png /users/k1806347/brc_scratch/Software/mdd-meta/docs/images/twas/Example.png
```

<details><summary>Show Example Image</summary>

![Example Figure](images/twas/Example.png)
