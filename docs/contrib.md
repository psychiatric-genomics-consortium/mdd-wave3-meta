...
```
snakemake -j4 --use-conda --cluster 'sbatch -t 60' analysis --groups analysis_part1=group0 analysis_part2=group0 analysis=group1 --group-components group0=16 group1=16
```
