#!/usr/bin/Rscript
library(data.table)
gwas<-fread('results/distribution/daner_pgc_mdd_full_eur_hg19_v3.49.24.09.neff.gz')
...
fwrite(gwas, 'results/twas/munged_gwas/daner_pgc_mdd_full_eur_hg19_v3.49.24.09.neff_COJO.txt', quote=F, na='NA', sep=' ')
