...
```{bash, eval=T, echo=F}
cp ../results/twas/twas_results/PGC_MDD3_twas_AllTissues_GW_Manhattan.png images/twas/
```

<center>

![MDD TWAS Manhattan Plot with transcriptome-wide signficance](images/twas/PGC_MDD3_twas_AllTissues_GW_Manhattan.png)
