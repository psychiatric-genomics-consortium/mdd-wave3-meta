...
finemap<-fread('../../results/finemapping/Locus_FineMapping_Full_Results.csv')
...
fastbat<-fread('../../results/Howard/mdd_fastbat_AllgeneMatrix.gene.fastbat')
...
hmagma<-fread('../../results/Pathak/PGC_MDD_Results_mar2022.csv')
...
for(i in 1:22){
  if(i != 6){
    pwas<-rbind(pwas, fread(paste0('../../results/pwas/PGC_MDD3_pwas_rosmap_chr',i)))
  } else {
    pwas<-rbind(pwas, fread(paste0('../../results/pwas/PGC_MDD3_pwas_rosmap_chr',i)))
    pwas<-rbind(pwas, fread(paste0('../../results/pwas/PGC_MDD3_pwas_rosmap_chr',i,'.MHC')))
  }
}
...
pwas_smr_rosmap_banner<-fread('../../results/pwas/rosmap_banner_pwas_smr_results.csv')
...
protein_highconf<-pwas_smr_rosmap_banner$ID[which(pwas_smr_rosmap_banner$banner_replicated & pwas_smr_rosmap_banner$smr_replicated & pwas_smr_rosmap_banner$rosmap.causal & pwas_smr_rosmap_banner$banner.causal & pwas_smr_rosmap_banner$smr.causal)]
...
png('../../docs/figures/gene_con_heatmap.png', units = 'px', res=300, height=14000, width=2600)
