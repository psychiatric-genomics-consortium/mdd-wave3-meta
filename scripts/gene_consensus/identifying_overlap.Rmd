...
Genes <- merge(Genes37, Genes38[,c('ensembl_gene_id', 'external_gene_name', 'hgnc_symbol')], by='ensembl_gene_id', all.x=TRUE, suffix=c('.37', '.38'))

# copy over build 37 gene name if it is missing in 
