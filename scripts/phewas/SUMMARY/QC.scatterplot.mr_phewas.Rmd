...
ggarrange(plotlist = fig.MDD_to_pheno.per_trait.brain[11:19],
            labels=labels.brain[11:19],ncol=1)
```
...
```{r, warning=F,echo=F,error=F,message=F,fig.width=9,fig.height=28,fig.align='center'}
...
```{r, warning=F,echo=F,error=F,message=F,fig.width=9,fig.height=56,fig.align='center'}
