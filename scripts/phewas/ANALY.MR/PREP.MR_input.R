...
# d.mdd = 'data/MR/MR_InterFiles/mdd_exposure_outcome'
# d.pheno = 'data/MR/MR_InterFiles/pheno_exposure_outcome'
# f.output = 'data/MR/ls.mr_analysis.rds'
# f.mismatch = 'data/MR/ls.mr_mismatch.RData'
