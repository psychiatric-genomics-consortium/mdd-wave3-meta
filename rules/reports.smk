...
rule report_metaqc:
	input: meta_qc_align="docs/tables/meta_qc_align.txt", meta_qc_ldsc="docs/tables/meta_qc_ldsc.txt", meta_qc_ldsc_pairs="docs/tables/meta_qc_ldsc_pairs.txt", cohorts_mdd="docs/tables/cohorts_mdd.eur.txt", rmd="docs/metaqc.Rmd"
	params:
		maf=meta_qc_params['maf'],
		info=meta_qc_params['info']
	output: "docs/metaqc.md"
	conda: "../envs/reports.yaml"
	script: "../docs/metaqc.Rmd"
